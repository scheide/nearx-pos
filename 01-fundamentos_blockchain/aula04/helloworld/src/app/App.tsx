...
const privateKey = bsv.PrivateKey.fromHex(
  "3c2ffdbb0a57c0cff0deacba15a92bf1d218dda9a9c7c668dd0640a6204b6394",
  ...
  return (
    <div className="App">
      <header className="App-header">
        <h2
          style={{ fontSize: "34px", paddingBottom: "5px", paddingTop: "5px" }}
        >
